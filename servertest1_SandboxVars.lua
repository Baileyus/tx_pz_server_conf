SandboxVars = {
    ...
    DKZombies = {
        ...
        -- Minimum=0 Maximum=50 Default=50
        dk_clim = 50,
        -- Minimum=0 Maximum=50 Default=7
        dk_clim3 = 7,
        ...
        -- Minimum=0 Maximum=50 Default=50
        dk_wfat = 50,
        -- Minimum=0 Maximum=50 Default=5
        dk_neverdie = 5,
        -- Minimum=0 Maximum=50 Default=50
        skeleton8 = 50,
        -- Minimum=0 Maximum=50 Default=50
